            ...
            <input type="text" name="id_producto" value="{{$producto->id}}" hidden>
                ...
                <div class="row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" name="stockMinimo" id="validacion04" required value="{{old('stockMinimo')}}">
                        <div class="valid-feedback">
                            ¡Correcto!
                        </div>
                        <div class="invalid-feedback">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" name="costo" id="validacion05" required value="{{old('costo')}}">
                            <div class="valid-feedback">
                                ¡Correcto!
                            </div>
                            <div class="invalid-feedback">
